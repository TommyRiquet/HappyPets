  ...
  return (
    <div className="AnimalCard">
      <Card className="annonce-card">
        <Card.Body>
          <Row>
            <Col className="type-annonce-col">
          ...
          <Row>
            <Col>
              {props.annonce.Pets.map((pet, index) =>
                index >= MaxNumberOfPetsPerAnnonce ? null : (
                      ...
                      <Row>
                        <Col>
                          <img
                            ...
                            alt="AnimalProfilePicture"
                          />
                        </Col>
                      </Row>
                      <Row>
                        <Col className={"annonce-pets-information"}>
                          {props.annonce.Pets[index].Sexe === "F" ? (
                            <img
                              data-testid={"annonce-pets-sexe" + index}
                              src={FIcon}
                              alt="F-icon"
                              width={20}
                            ></img>
                          ) : props.annonce.Pets[index].Sexe === "M" ? (
                            <img
                              data-testid={"annonce-pets-sexe" + index}
                              src={MIcon}
                              alt="M-icon"
                          ...
                          <span data-testid={"annonce-pets-weight" + index}>
                            {props.annonce.Pets[index].Weight === null
                              ? " "
                              : ", " + props.annonce.Pets[index].Weight + "kg"}
                          </span>
                        </Col>
                      </Row>
                    </Col>
                      ...
                      <Row>
                        <Col className="annonce-sterile-checkbox">
                          <input
                            ...
                            checked={pet.Sterile}
                            disabled
                            data-testid={"annonce-sterile-checkbox" + index}
                          />
                          <label labelfor="sterile-checkbox">
                            Stérilisation
                          </label>
                        </Col>
                      </Row>
            ...
            <Col xs={1} md={1} lg={1} xl={1} xxl={1}>
              <Row className="annonce-date" data-testid={"annonce-date"}>
                <Col>
                  {props.annonce.DateBegin.slice(5, 10).replace("-", "/") +
                    ">" +
                    props.annonce.DateEnd.slice(5, 10).replace("-", "/")}
                </Col>
              </Row>
              <Row
                className="annonce-localite"
                data-testid={"annonce-user-city"}
              >
                <Col>
